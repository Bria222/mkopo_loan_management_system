...
<html lang="en">
    ...
    <body>
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <!-- Navbar Brand-->
            <a class="navbar-brand ps-3" href="index.php">AdvancedTech</a>
            <!-- Sidebar Toggle-->

            <!-- Navbar Search-->
          <div class=" logologo "><img class="pic-logo " src="assets/img/logo.jpg" alt=""></div>
        </nav>
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">ADVANCE UI WITH DATABASE</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item btn btn-info"><a href="index.php">Home</a></li>
